...
public class DeliveryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cityspinner = (Spinner) findViewById(R.id.delivery_city);
        final List<String> qty;
        qty = new ArrayList<String>();
        qty.add("Roorkee");
        ArrayAdapter<String> qtydataAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, qty);
        cityspinner.setAdapter(qtydataAdapter);
